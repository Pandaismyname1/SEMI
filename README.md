...
Minecraft 26.1, 26.2 and 26.3 require Java 25. Fabric builds need Fabric API; NeoForge builds need NeoForge 26.1.2 or newer (26.1) or NeoForge 26.2.0 or newer (26.2). Each Minecraft version has its own branch and its own release, for example `1.1.24+26.1.2` for 26.1.2 and `1.1.24+26.2` for 26.2.
