...
### Port
* Ported to Minecraft 26.2 for Fabric and NeoForge (Java 25). Built against Fabric API 0.161.0+26.2, NeoForge 26.2.0.88, the JEI 30.35 API and ModMenu 20.0.2, on top of the MIT community port by link-fgfgui, merged with full attribution.
