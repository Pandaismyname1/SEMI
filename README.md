...
- The Minecraft 26.1, 26.2 and 26.3 ports build on the MIT-licensed community port by **[link-fgfgui](https://github.com/link-fgfgui/emi)**, merged with full commit attribution, which in turn drew on work by [Dabolus](https://github.com/Dabolus/MEMI) and others.
...
|-----------|--------|----------|--------|
| 26.3      | yes    | yes (NeoForge beta builds) | `26.3` |
| 26.2      | yes    | yes      | `26.2` |
| 26.1.x    | yes    | yes      | `26.1` |

Minecraft 26.1, 26.2 and 26.3 require Java 25. Fabric builds need Fabric API; NeoForge builds need NeoForge 26.1.2 or newer (26.1), NeoForge 26.2.0 or newer (26.2) or NeoForge 26.3.0 or newer (26.3; only beta builds of NeoForge exist for 26.3 at the time of writing). Each Minecraft version has its own branch and its own release, for example `1.1.24+26.1.2` for 26.1.2, `1.1.24+26.2` for 26.2 and `1.1.24+26.3` for 26.3.
